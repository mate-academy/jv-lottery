...
Then create a `core.basesyntax.Lottery` class with `getRandomBall()` method, which will return the ball.
...
To test the program, in main() method, create three balls using `getRandomBall()` method from `core.basesyntax.Lottery` class.
